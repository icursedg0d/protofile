...
func (x *ReqisterResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *LoginRepsonse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginRepsonse) ProtoMessage() {}

func (x *LoginRepsonse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginRepsonse.ProtoReflect.Descriptor instead.
func (*LoginRepsonse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{3}
}

func (x *LoginRepsonse) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x71, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x17,
	...
	0x22, 0x25, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x70, 0x73, 0x6f, 0x6e, 0x73,
	...
	0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x71, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	...
	0x70, 0x73, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x07, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69,
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*LoginRepsonse)(nil),    // 3: auth.LoginRepsonse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	3, // 4: auth.Auth.Login:output_type -> auth.LoginRepsonse
